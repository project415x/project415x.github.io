/*
 * Unused functions that have been deleted from other files.
 * -Cary
 */
...
/**
* drawVector
* @description: Draws the vector based on the proccessed data
*/
...
/**
* drawAngle
* @description: Draws the angle of the vector
*/
